...
export default class PuppeteerNetworkCache extends PuppeteerExtraPlugin {
    ...
    public requestValidatorFn: (request: ExtendedPuppeteerHTTPRequest) => boolean | Promise<boolean>;
    ...
    public responseValidatorFn: (response: ExtendedPuppeteerHTTPResponse) => boolean | Promise<boolean>;
